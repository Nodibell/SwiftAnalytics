...
## ⚡ Comparative Benchmark Suite (SwiftSci 2.0 vs Python)
...
| **Holt-Winters Fit (50k pts)** | **6.77 ms** | 143.02 ms (*Statsmodels*) | ⚡ **21.1× Faster** | 🟢 Swift |
| **RandomForest Fit (1k×4, 50 trees)** | **4.81 ms** | 25.66 ms (*Scikit-Learn*) | ⚡ **5.3× Faster** | 🟢 Swift |
| **OneVsRestClassifier (5 classes)** | **0.73 ms** | 3.50 ms (*Scikit-Learn*) | ⚡ **4.8× Faster** | 🟢 Swift |
| **KernelSHAP Explain (100 coalitions)** | **0.11 ms** | 0.48 ms (*SHAP Python*) | ⚡ **4.4× Faster** | 🟢 Swift |
| **TF-IDF Vectorizer (50 docs)** | **1.01 ms** | 4.20 ms (*Scikit-Learn*) | ⚡ **4.1× Faster** | 🟢 Swift |
| **TreeSHAP Explain (100 samples)** | **0.14 ms** | 0.52 ms (*SHAP Python*) | ⚡ **3.7× Faster** | 🟢 Swift |
| **Mean Reduction (vDSP 1M)** | **0.086 ms** | 0.122 ms (*NumPy*) | ⚡ **1.4× Faster** | 🟢 Swift |
